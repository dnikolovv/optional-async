...
namespace Optional.Async.Extensions
{
    public static class OptionAsyncExtensions
    {
        ...
        public static Task<Option<TResult, TException>> FlatMapAsync<T, TException, TResult>(this Task<Option<T, TException>> option, Func<T, Task<Option<TResult, TException>>> mapping) =>
            option.MatchAsync(
                ...
                none: err => Task.FromResult(Option.None<TResult, TException>(err)));
        ...
        public static Task<Option<T, TExceptionResult>> MapExceptionAsync<T, TException, TExceptionResult>(this Task<Option<T, TException>> optionTask, Func<TException, Task<TExceptionResult>> mapping) =>
            optionTask.MatchAsync(
                some: val => Task.FromResult(Option.Some<T, TExceptionResult>(val)),
        ...
        public static async Task<Option<T, TException>> WithExceptionAsync<T, TException>(this Task<Option<T>> option, TException exception) =>
